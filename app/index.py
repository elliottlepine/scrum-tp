...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Récupère des infos d\'un pdf')
    action = parser.add_mutually_exclusive_group(required=True)

    action.add_argument('-t', '--text', metavar='pdfFilename', help='Infos au format text')
    action.add_argument('-x', '--xml', metavar='pdfFilename', help='Infos au format pdf')
